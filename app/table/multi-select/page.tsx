...
export default function MockPage() {
  return (
    <div className="flex flex-col gap-6 p-6">
      {/* Action Toolbar Showcase */}
      <div className="flex flex-col gap-4 bg-gray-100 p-8 rounded-lg">
        <h2 className="text-2xl font-bold text-gray-900">Action Toolbar (Multi-select)</h2>
        <div className="bg-background rounded-md border p-6 flex justify-center">
          <ActionToolbar />
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 bg-gray-100 p-8 rounded-lg">
        ...
        <div className="flex justify-center">
          <div className="relative w-[1440px] h-[900px] bg-gray-50 flex flex-col border border-gray-300 rounded-lg overflow-hidden shadow-lg">
            ...
            {/* Action Toolbar - Floating at bottom center */}
